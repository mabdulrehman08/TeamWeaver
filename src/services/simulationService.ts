import { createMockComparison, createMockSimulationResponse } from "../mock/mockSimulationResponse";
import type { ComparisonResult, SimulationEvent, SimulationResult } from "../types/simulation";
